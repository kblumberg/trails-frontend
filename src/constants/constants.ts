...
// @ts-ignore
export const TEST_TOKEN = new PublicKey( NETWORK == 'https://api.devnet.solana.com' ? 'GuBVxVbKtM9XkRnmqv1E7RkARsoERncdZeCtezfeYLAD' : '5SosK71HJr9UpcwopNam8X9ZnuonDoGERjziWSnws4u4');
